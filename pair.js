...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029VbC1YPcBPzjPQpndDO0Z) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [☠︎︎𓆩ᴰᵃʳᴋ᭄🖤𓆩𝗥𝗔𝗝𝗣𝗢𝗢𝗧¹⁴⁶࿐ GitHub Repo](https://github.com/xdarkprince146/)  

🚀 _Thanks for choosing DARK_MD-146 — Let the automation begin!_ ✨`;

                    await Malvin.sendMessage(Malvin.user.id, { text: DARK_TEXT }, { quoted: session });
